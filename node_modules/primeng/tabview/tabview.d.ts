import { AfterContentInit, AfterViewChecked, AfterViewInit, ChangeDetectorRef, ElementRef, EmbeddedViewRef, EventEmitter, OnDestroy, QueryList, TemplateRef, ViewContainerRef } from '@angular/core';
...
export declare class TabView implements AfterContentInit, AfterViewChecked, OnDestroy, BlockableUI, AfterViewInit {
    private platformId;
    el: ElementRef;
    cd: ChangeDetectorRef;
    orientation: string;
