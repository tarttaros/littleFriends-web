...
import { BlockableUI, FilterService, PrimeNGConfig } from 'primeng/api';
...
export declare class DataView implements OnInit, AfterContentInit, OnDestroy, BlockableUI, OnChanges, AfterViewInit {
    el: ElementRef;
