import { AfterContentInit, AfterViewInit, ChangeDetectorRef, ElementRef, EventEmitter, QueryList, TemplateRef } from '@angular/core';
...
export declare class VirtualScroller implements AfterContentInit, BlockableUI, AfterViewInit {
    el: ElementRef;
