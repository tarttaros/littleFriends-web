import { AfterContentInit, AfterViewInit, EventEmitter, QueryList, TemplateRef } from '@angular/core';
...
export declare class Breadcrumb implements AfterContentInit, AfterViewInit {
    model: MenuItem[];
    style: any;
    styleClass: string;
    home: MenuItem;
