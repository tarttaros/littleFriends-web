import { AfterContentInit, AfterViewInit, ChangeDetectorRef, ElementRef, EventEmitter, Injector, OnChanges, OnInit, QueryList, SimpleChanges, TemplateRef } from '@angular/core';
...
export declare class InputNumber implements OnInit, AfterContentInit, OnChanges, ControlValueAccessor, AfterViewInit {
    private document;
    el: ElementRef;
    private cd;
