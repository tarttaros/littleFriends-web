import { AfterContentInit, AfterViewInit, ChangeDetectorRef, DoCheck, ElementRef, EventEmitter, NgZone, OnDestroy, OnInit, PipeTransform, QueryList, Renderer2, TemplateRef } from '@angular/core';
...
export declare class PasswordDirective implements OnDestroy, DoCheck, AfterViewInit {
    private document;
    private platformId;
    private renderer;
    el: ElementRef;
...
export declare class Password implements AfterContentInit, OnInit, AfterViewInit {
    private document;
    private platformId;
    private renderer;
    private cd;
