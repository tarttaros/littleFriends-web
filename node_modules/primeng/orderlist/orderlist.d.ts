...
import { AfterContentInit, AfterViewChecked, AfterViewInit, ChangeDetectorRef, ElementRef, EventEmitter, QueryList, Renderer2, TemplateRef } from '@angular/core';
...
export declare class OrderList implements AfterViewChecked, AfterContentInit, AfterViewInit {
    private document;
    private platformId;
    private renderer;
    el: ElementRef;
