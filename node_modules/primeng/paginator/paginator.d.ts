import { AfterContentInit, AfterViewInit, ChangeDetectorRef, EventEmitter, OnChanges, OnInit, QueryList, SimpleChanges, TemplateRef } from '@angular/core';
...
export declare class Paginator implements OnInit, AfterContentInit, OnChanges, AfterViewInit {
    private cd;
    pageLinkSize: number;
