import { AfterContentInit, AfterViewInit, ChangeDetectorRef, QueryList, TemplateRef } from '@angular/core';
...
export declare class PanelMenu extends BasePanelMenuItem implements AfterContentInit, AfterViewInit {
    model: MenuItem[];
    style: any;
    styleClass: string;
    multiple: boolean;
